...
//     console.log("user or meber : ", userOrMem);
...
//     formData.append("upload_preset", "gym_members_unsigned"); // from Cloudinary settings
...
//     return res.data.secure_url; // this is the URL you store in your DB
//     };
...
//             navigate("/plans", { state: { mobNo: payload.mob_no, mName: payload.mname, planName, price, durationDays } });
//         }catch(err){
